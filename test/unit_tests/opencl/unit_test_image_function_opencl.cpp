...
namespace image_function_opencl
{
    ...
    bool AbsoluteDifference2ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            std::vector < PenguinV_Image::Image > input = OpenCL::uniformImages( intensity );

            PenguinV_Image::Image output = Image_Function_OpenCL::AbsoluteDifference( input[0], input[1] );
    ...
    bool AbsoluteDifference3ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            std::vector < PenguinV_Image::Image > image = OpenCL::uniformImages( intensity );
    ...
    bool BitwiseAnd2ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            PenguinV_Image::Image output = Image_Function_OpenCL::BitwiseAnd( input[0], input[1] );
    ...
    bool BitwiseOr2ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            PenguinV_Image::Image output = Image_Function_OpenCL::BitwiseOr( input[0], input[1] );
    ...
    bool ConvertToGrayScale1ParameterTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            PenguinV_Image::Image input = OpenCL::uniformRGBImage( intensity[0] );

            PenguinV_Image::Image output = Image_Function_OpenCL::ConvertToGrayScale( input );
    ...
    bool ConvertToRgb1ParameterTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            std::vector < uint8_t > intensity = intensityArray( 1 );
            PenguinV_Image::Image input = OpenCL::uniformImage( intensity[0] );

            PenguinV_Image::Image output = Image_Function_OpenCL::ConvertToRgb( input );
    ...
    bool GammaCorrection3ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            PenguinV_Image::Image input = OpenCL::uniformImage( intensity );

            double a     = randomValue <uint32_t>( 100 ) / 100.0;
            double gamma = randomValue <uint32_t>( 300 ) / 100.0;

            PenguinV_Image::Image output = Image_Function_OpenCL::GammaCorrection( input, a, gamma );
    ...
    bool Histogram1ParameterTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            uint8_t intensity = intensityValue();
            PenguinV_Image::Image image = OpenCL::uniformImage( intensity );

            std::vector < uint32_t > histogram = Image_Function_OpenCL::Histogram( image );
    ...
    bool Invert1ParameterTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            PenguinV_Image::Image output = Image_Function_OpenCL::Invert( input );
    ...
    bool LookupTable2ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            std::vector < uint8_t > intensity = intensityArray( 2 );
            PenguinV_Image::Image input = Image_Function_OpenCL::ConvertToOpenCL(randomImage( intensity ));
            ...
            PenguinV_Image::Image output = Image_Function_OpenCL::LookupTable( input, lookupTable );
    ...
    bool Maximum2ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            PenguinV_Image::Image output = Image_Function_OpenCL::Maximum( input[0], input[1] );
    ...
    bool Minimum2ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            PenguinV_Image::Image output = Image_Function_OpenCL::Minimum( input[0], input[1] );
    ...
    bool Subtract2ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            PenguinV_Image::Image output = Image_Function_OpenCL::Subtract( input[0], input[1] );
    ...
    bool Threshold2ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            Image_Function_OpenCL::Image output = Image_Function_OpenCL::Threshold( input, threshold );
    ...
    bool ThresholdDouble3ParametersTest()
    {
        for( uint32_t i = 0; i < runCount(); ++i ) {
            ...
            PenguinV_Image::Image output = Image_Function_OpenCL::Threshold( input, minThreshold, maxThreshold );
