...
namespace
{
    ...
    {
        std::vector < PenguinV_Image::Image > image = Performance_Test::OpenCL_Helper::uniformImages( 3, size, size );
    ...
    {
        std::vector < PenguinV_Image::Image > image = Performance_Test::OpenCL_Helper::uniformImages( 2, size, size );
    ...
    {
        std::vector < PenguinV_Image::Image > image = Performance_Test::OpenCL_Helper::uniformImages( 1, size, size );
