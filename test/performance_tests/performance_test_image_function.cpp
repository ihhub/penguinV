...
namespace Function_Template
{
    ...
    {
        std::vector < PenguinV_Image::Image > image = Test_Helper::uniformImages( 3, size, size );
    ...
    {
        const PenguinV_Image::Image image = Test_Helper::uniformImage( size, size );
    ...
    {
        PenguinV_Image::Image input  = Test_Helper::uniformRGBImage( size, size );
        PenguinV_Image::Image output = Test_Helper::uniformImage   ( size, size );
    ...
    {
        PenguinV_Image::Image input  = Test_Helper::uniformImage   ( size, size );
        PenguinV_Image::Image output = Test_Helper::uniformRGBImage( size, size );
    ...
    {
        std::vector < PenguinV_Image::Image > image = Test_Helper::uniformRGBImages( 2, size, size );
    ...
    {
        PenguinV_Image::Image input  = Test_Helper::uniformImage( size, size );
        PenguinV_Image::Image output = Test_Helper::uniformImage( size / 2, size / 2 );
