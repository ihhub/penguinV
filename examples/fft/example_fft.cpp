// Example application of fft
#include <iostream>
#include "../../src/fft.h"
#include "../../src/filtering.h"
#include "../../src/thirdparty/kissfft/kiss_fftnd.h"
#include "../../src/thirdparty/kissfft/kiss_fft.h"
...
int main( int argc, char * argv[] )
{
    ...
    try // <---- do not forget to put your code into try.. catch block!
    {
        ...
        for ( size_t i = 0; i < filePaths.size(); ++i ) {
            ...
            FFT::ComplexData complex_data=FFT::ComplexData(image);
            FFT::FFTExecutor fft(image.width(),image.height());
            fft.directTransform(complex_data);
