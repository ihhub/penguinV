...
namespace Image_Function_Cuda
{
    ...
    void AbsoluteDifference( const Image & in1, const Image & in2, Image & out )
    {
        ...
        launchKernel2D( absoluteDifferenceCuda, out.rowSize(), out.height(),
                        in1.data(), in2.data(), out.data(), out.rowSize(), out.height() );
    }
    ...
    void BitwiseAnd( const Image & in1, const Image & in2, Image & out )
    {
        ...
        launchKernel2D( bitwiseAndCuda, out.rowSize(), out.height(),
                        in1.data(), in2.data(), out.data(), out.rowSize(), out.height() );
    }
    ...
    void BitwiseOr( const Image & in1, const Image & in2, Image & out )
    {
        ...
        launchKernel2D( bitwiseOrCuda, out.rowSize(), out.height(),
                        in1.data(), in2.data(), out.data(), out.rowSize(), out.height() );
    }
    ...
    void BitwiseXor( const Image & in1, const Image & in2, Image & out )
    {
        ...
        launchKernel2D( bitwiseXorCuda, out.rowSize(), out.height(),
                        in1.data(), in2.data(), out.data(), out.rowSize(), out.height() );
    }
    ...
    void ConvertToGrayScale( const Image & in, Image & out )
    {
        ...
        launchKernel2D( convertToGrayScaleCuda, out.width(), out.height(),
                        in.data(), out.data(), in.width(), in.height(), in.colorCount() );
    }
    ...
    void  ConvertToRgb( const Image & in, Image & out )
    {
        ...
        if( in.colorCount() == RGB ) {
            ...
            launchKernel2D( convertToRgbCuda, out.width(), out.height(),
                            in.data(), out.data(), in.width(), in.height(), out.colorCount() );
        }
    }
    ...
    void ExtractChannel( const Image & in, Image & out, uint8_t channelId )
    {
        ...
        launchKernel2D( extractChannelCuda, out.width(), out.height(),
                        in.data(), out.data(), out.width(), out.height(), in.colorCount(), channelId );
    }
    ...
    void Fill( Image & image, uint8_t value )
    {
        ...
        launchKernel1D( fillCuda, size,
                        image.data(), value, size );
    }
    ...
    void  Flip( const Image & in, Image & out, bool horizontal, bool vertical )
    {
        ...
        if( !horizontal && !vertical ) {
            ...
            launchKernel2D( flipCuda, out.rowSize(), out.height(),
                            in.data(), out.data(), out.rowSize(), out.height(), horizontal, vertical );
        }
    }
    ...
    void Histogram( const Image & image, std::vector < uint32_t > & histogram )
    {
        ...
        launchKernel2D( histogramCuda, image.rowSize(), image.height(),
                        image.data(), image.rowSize(), image.height(), tableCuda.data() );
    ...
    void Invert( const Image & in, Image & out )
    {
        ...
        launchKernel2D( invertCuda, out.rowSize(), out.height(),
                        in.data(), out.data(), out.rowSize(), out.height() );
    }
    ...
    void LookupTable( const Image & in, Image & out, const std::vector < uint8_t > & table )
    {
        ...
        launchKernel2D( lookupTableCuda, out.rowSize(), out.height(),
                        in.data(), out.data(), out.rowSize(), out.height(), tableCuda.data() );
    }
    ...
    void Maximum( const Image & in1, const Image & in2, Image & out )
    {
        ...
        launchKernel2D( maximumCuda, out.rowSize(), out.height(),
                        in1.data(), in2.data(), out.data(), out.rowSize(), out.height() );
    }
    ...
    void Minimum( const Image & in1, const Image & in2, Image & out )
    {
        ...
        launchKernel2D( minimumCuda, out.rowSize(), out.height(),
                        in1.data(), in2.data(), out.data(), out.rowSize(), out.height() );
    }
    ...
    void Subtract( const Image & in1, const Image & in2, Image & out )
    {
        ...
        launchKernel2D( subtractCuda, out.rowSize(), out.height(),
                        in1.data(), in2.data(), out.data(), out.rowSize(), out.height() );
    }
    ...
    void Threshold( const Image & in, Image & out, uint8_t threshold )
    {
        ...
        launchKernel2D( thresholdCuda, out.rowSize(), out.height(),
                        in.data(), out.data(), out.rowSize(), out.height(), threshold );
    }
    ...
    void Threshold( const Image & in, Image & out, uint8_t minThreshold, uint8_t maxThreshold )
    {
        ...
        launchKernel2D( thresholdCuda, out.rowSize(), out.height(),
                        in.data(), out.data(), out.rowSize(), out.height(), minThreshold, maxThreshold );
    }
}
