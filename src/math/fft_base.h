...
namespace FFT 
{
    ...
    */
    ...
    protected:
       ...
       virtual void _allocateData(size_t nBytes) = 0; // Override to deal with actual memory allocation.
...
///////////////////////////////////////////////////////
    ...
    void BaseComplexData<DataType>::resize(uint32_t width_, uint32_t height_ )
    {
        ...
        if( !dimensionsMatch(width_, height_) && width_ != 0 && height_ != 0 ) {
            ...
            const uint32_t nElements = width_ * height_;

            _allocateData(nElements * sizeof(DataType));
